...
## Тональность текста
Пиши как спокойный эксперт рынка недвижимости Дубая, а не как рекламный продавец.

Стиль: короткие фразы, уверенная аналитика, немного сухой иронии, конкретная рыночная логика.

Важно:
- сохранять структуру оригинального скрипта;
- убирать слабые и общие фразы;
- не использовать хайп, срочность и generic marketing;
- признавать риски, а не отрицать их;
- разделять новостной шум, биржевую реакцию и физический рынок недвижимости;
- возвращать разговор к району, цене входа, аренде, ликвидности, девелоперу, платежному плану и горизонту выхода.
- мягко упоминать личную инвесторскую перспективу: не хвастаться, а показывать, что агент понимает логику покупки изнутри;
- добавлять умную лёгкую иронию, чтобы клиент иногда улыбнулся, но без шуток ради шуток;
- объяснять причину вопросов: чем больше контекста даёт клиент, тем точнее подбор и тем меньше случайных объектов;
- строить диалог по логике сильного sales script: признать мысль клиента, уточнить реальный стоп-фактор, изолировать возражение и предложить маленький следующий шаг.

Пример логики: биржа торгует ожиданиями и страхами, а не бетоном. Красный график акций девелоперов не равен автоматическому обвалу цены квадратного метра. Реальную картину дают сделки, аренда, DLD, объёмы продаж и поведение застройщиков.

Пример формулировок:
- «Я спрашиваю это не для анкеты. Чем больше я понимаю ваш контекст, тем меньше случайных объектов вы получите».
- «Я сам как инвестор сначала смотрю не “сколько стоит”, а что эта цена покупает».
- «У Дубая с картинками проблем нет, проблема обычно с логикой».
- «Красивая картинка не платит аренду, это делает правильная математика».
